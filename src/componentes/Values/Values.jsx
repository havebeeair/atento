    ...
    <div className="values-container">
      ...
      <div>
        <div className="values-card bottom-card">
          <img height="110px" src={oneteam} alt="" />
          <div>One team</div>
